...
from app.models.model_turnament import Tournament, Player, TournamentRound, Match1vs1
...
def tournaments_list():
    if request.method == 'GET':
        ...
        return render_template('tournaments_list.html', result=result)
...
def manual_setting_tournament_scheme(tournament_id):
    if request.method == 'POST':
        ...
        return render_template('edit_schema_tournament.html',
                               tournament=tournament)
...
def delete_round_scheme(tournament_id):
    ...
    db.session.commit()
    return render_template('tournament_info.html', tournament=tournament)
...
def save_tournament():
    if request.method == 'POST':
        ...
        return render_template('tournament_info.html', tournament=tournament, owner=owner, users=users)
